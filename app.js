...
const dhBicis = {
    ...
    venderBici: function(id) {
        ...
        listarTodasLasBici: function() {
            this.bicicletas.forEach(bici => {
                console.log(`ID: ${bici.id}, Marca: ${bici.marca}, Modelo: ${bici.modelo}, Rodado: ${bici.rodado}, Año: ${bici.anioFabricacion}, Color: ${bici.color}, Peso: ${bici.pesoKg}kg, Tipo: ${bici.tipo}, Precio: $${bici.precio}, Vendida: ${bici.vendida ? 'Sí' : 'No'}`);
            });
        }
